...
<h1>Patient Registration Form</h1>
    <table cellspacing="0">
        <tr>
            ...
            <td class="cell"><b>ID Number <span style="color:red;"> * </span> &nbsp;&nbsp; <input readonly
                                                                name="patient.identifier" style="border: none; width: 250px; background:none;" /> </b>
            </td>
                ...
                <table cellspacing="10">
                    ...
                    <tr>
                        <td><input id="patCatGeneral" type="checkbox"
                                   name="person.attribute.14" value="Government" /> Government</td>

                        <td><input id="patCatNonGov" type="checkbox"
                                   name="person.attribute.14" value="Non Government" /> Non Government</td>

                        <td><input id="dependent" type="checkbox"
                                   name="person.attribute.14" value="Dependent" /> Dependent </td>
					
                    </tr>
					
					<!-- New code enter here Khairul-cTechbd and it's only for SKH Hospital  -->
				
                    <tr>
                        <td><b>Working Place:</b></td>
                        <td><input id="patientWorkPlace" name="patient.attribute.25" />
                            <!-- khairul, 05 November-2014 Work Place -->
                    ...
                    <tr>
                        ...
                        <td><input id="patientDesignation" name="patient.attribute.26" />
                            <!-- khairul, 05 November-2014 Designation -->
                        <td><span style="color: red;"
                                  id="nationalIdValidationMessage"> </span>
                        </td>
        ...
        <td class="cell"><b>Referral Information</b><br /> <input
            ...
            <div id="referralDiv" style="display: none;">
                <table>
                    ...
                    <tr>
                        <td>Referral Type</td>
                        <td><select id="referralReasons" name="patient.referred.reason" style="width: 200px;">
                            </select></td>
                    </tr>
                </table>
            </div> <b>OPD Room to Visit:<span style="color:red;"> * </span></b> <select id="opdWard" name="patient.opdWard">
            </select></td>
        </tr>
    </table>
