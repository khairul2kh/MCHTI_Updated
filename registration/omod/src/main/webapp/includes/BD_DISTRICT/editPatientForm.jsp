    ...
    jQuery(document).ready(
            function() {
                ...
                if (!StringUtils.isBlank(MODEL.patientAttributes[26])) {
                    formValues += "patient.attribute.26=="
    ...
    <table cellspacing="0">
        <tr>
            ...
            <td class="cell"><b>ID Number <span style="color:red;"> * </span> &nbsp;&nbsp; <input
                        name="patient.identifier" style="border: none; background:none;" /> </b></td>
        </tr>
        <tr>
        ...
        <b>&nbsp;&nbsp;Patient category</b><br />
                ...
                <table cellspacing="10">
                    ...
                    <tr>
                        ...
                        <td><input id="patientWorkPlace" name="patient.attribute.25" /> </td>
        ...
        <tr>
            <!--
        <td colspan="3" style="padding: 0em 30em 0em 30em;"><input type="button" value="Save" onclick="PAGE.submit();" />
