...
<tr>
	...
	<tr>
		<td>Unit<em>*</em></td>
		<td>
			<select name="units" id="units" onchange="RECEIPT.onChangeCategoryItem(this);"   style="width: 200px;">
				<option value="">Please Select</option>
                <c:forEach items="${unit}" var="vCat">
                    <option value="" <c:if test="${vCat.id == categoryId }">selected</c:if> >${vCat.name}</option>
                </c:forEach> 
   			</select>
		</td>
