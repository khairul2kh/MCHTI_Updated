...
public class ReceiptFormController {
   ...
   //     List<InventoryItemUnit> units = inventoryService.findItemUnit("");
	...
	public List<InventoryItemUnit> populateUnit() {
		InventoryService inventoryService = (InventoryService) Context.getService(InventoryService.class);
		List<InventoryItemUnit> unit = inventoryService.findItemUnit("");
		return unit; 
        }
    ...
    public String submit(HttpServletRequest request, Model model) {
        ...
        int unit=NumberUtils.toInt(request.getParameter("unit"),0);  /// For New Unit
     ...
     //   transactionDetail.setUnit(inventoryService.getItemUnitById(unit));
