...
<br />
<p>
	<openmrs:hasPrivilege privilege="Test Bill">
	<b><a href="searchDriver.form"><spring:message code="billing.ambulance" /></a></b>&nbsp; | &nbsp; 
	...
	<openmrs:hasPrivilege privilege="Test Bill">
	<b><a href="miscellaneousServiceBill.list"><spring:message code="billing.miscellaneousService" /></a> </b>&nbsp; | &nbsp; 
	</openmrs:hasPrivilege>
	
	<b><a href="billingqueue.form"><spring:message	code="billing.billingqueue" /></a></b>
</p>
<br />
