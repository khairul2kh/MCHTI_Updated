            ...
            function addDrugOrder() {
                ...
                if (drugName == null || drugName == "") {
                    ...
                    var htmlText = "<div id='com_" + drugName + "_div'>"
                            + "<input id='" + drugName + "_name'  name='drugOrder' type='text' size='32' value='" + drugName + "'  readonly='readonly'/>&nbsp;&nbsp;"
                            + "<input id='" + drugName + "_formulationName'  name='" + drugName + "_formulatioNname' type='text' size='32' value='" + formulationArr[0] + "'  readonly='readonly'/>&nbsp;&nbsp;"
                            + "<input id='" + drugName + "_frequencyName'  name='" + drugName + "_frequencyName' type='text' size='32' value='" + frequencyArr[0] + "'  readonly='readonly'/>&nbsp;&nbsp;"
                            + "<input id='" + drugName + "_noOfDays'  name='" + drugName + "_noOfDays' type='text' size='17' value='" + noOfDays + "'  readonly='readonly'/>&nbsp;&nbsp;"
                            + "<input id='" + drugName + "_comments'  name='" + drugName + "_comments' type='text' size='25' value='" + comments + "'  readonly='readonly'/>&nbsp;&nbsp;"
                ...
                <tr>
                    <td width="70%">
                        <div class="" id="drugOrder"
                             style="background: #FFFFFF; border: 1px #808080 solid; padding: 0.3em; margin: 0.3em 0em; min-width: 20em; height: 5em;">
                ...
                <tr>	
                    <td>
                        ...
                        <div id="headerValue"
                            ...
                            <input type='hidden' id="drug" name="drug" value='Drugs' size="32"
                                   readonly="readonly" />&nbsp; 
                            <input type='hidden' id="formulation"
                                   name='formulation' value="Formulation" size="32"
                                   readonly="readonly" />&nbsp;&nbsp;&nbsp;&nbsp; 
                            <input type='hidden' id='frequency'
                                   name='frequency' value='Frequency' size="32" readonly="readonly" />&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
