...
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		//map.put("/module/radiology/listDepartment.form", "radiology.department.manage");
		//map.put("/module/radiology/listForm.form", "radiology.form.manage");
		//map.put("/module/radiology/listTemplate.form", "radiology.template.manage");
		map.put("/module/radiology/radiologyCustomFormList.form", "Custom Form");
		return map;
	}
