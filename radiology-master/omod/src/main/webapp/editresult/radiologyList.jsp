...
<br/>
<openmrs:require privilege="Manage Radiology Worklist" otherwise="/login.htm" redirect="/module/radiology/editRadiologyResult.form" />
...
<script type="text/javascript">
	...
	this.currentPage = currentPage;
		...
		jQuery.ajax({
			type : "GET",
			url : getContextPath() + "/module/radiology/completedRadiologyTest.form",
			data : ({
				date			: date,
				phrase			: phrase,
			...
			error : function(xhr, ajaxOptions, thrownError) {
				/* alert("ERROR " + xhr); */	
				alert("Error! Please check investigation is selected");
			}
		});
	}
	...
	//type = escape(type);
		tb_show("testing", "result.htm?modal=true&height=700&width=1000&testId=" + testId);
	
     // var url = "result.htm?testId=" + testId + "&KeepThis=true&TB_iframe=true&width=800&height=500";
           // tb_show("Enter Result", url);
    }
...
<div class="box">
	...
	<br/>
	<input type="button" value="Get Tests" onClick="getTests();"/>
</div>
